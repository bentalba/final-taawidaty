...
export default function CookiePreferences() {
  ...
  const content = {
    fr: {
      ...
      gdprDescription: "Conformément au RGPD, vous avez le droit d'accéder, de rectifier, de supprimer ou de limiter l'utilisation de vos données personnelles. Contactez-nous à admin@taawidaty.ma",
    ...
    ar: {
      ...
      gdprDescription: "وفقًا لـ RGPD، لديك الحق في الوصول إلى بياناتك الشخصية أو تصحيحها أو حذفها أو تقييد استخدامها. اتصل بنا على admin@taawidaty.ma",
